...
class VendorDetailMobilePage extends StatefulWidget {
  ...
  const VendorDetailMobilePage({Key key, @required this.isEditing, this.vendor})
      : super(key: key);

  @override
  _VendorDetailMobilePageState createState() => _VendorDetailMobilePageState();
}
...
// }
class _VendorDetailMobilePageState extends State<VendorDetailMobilePage> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((prefs) {
      ...
      phoneController.text =
          widget.isEditing ? _formatNumber(widget.vendor.phone.toString()) : "";
